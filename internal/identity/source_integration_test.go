...
// person made.
//
// The skip is the `decided` branch of Resolve, which reads is_manual. This test
// is what stops a later change to how a source identity is written — dropping
// is_manual, say — from quietly handing the file back to the resolver.
